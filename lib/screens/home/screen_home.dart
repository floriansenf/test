...
class _BottomNavigationState extends State<BottomNavigation> {
  ...
  final appbar = [
    AppBar(
      title: Text("*Firmenname* Vertrieb"),
...
class FilePicker2 extends StatefulWidget {
  const FilePicker2({Key key}) : super(key: key);

  @override
  _FilePickerState createState() => _FilePickerState();
}

class _FilePickerState extends State<FilePicker2> {
